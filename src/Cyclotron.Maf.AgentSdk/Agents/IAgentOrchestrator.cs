...
/// <summary>
/// Provider-aware orchestration interface for creating and managing AI agents.
/// This is the primary abstraction for agent lifecycle and execution behavior.
/// </summary>
public interface IAgentOrchestrator
{
    ...
    /// <summary>
    /// Gets the agent key/identifier for this orchestrator.
    /// </summary>
    string AgentKey { get; }

    /// <summary>
    /// Gets the agent definition options for this orchestrator.
    /// </summary>
